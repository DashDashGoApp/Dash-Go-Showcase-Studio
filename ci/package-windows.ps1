...
$PostSelfTestInstalledPayloadFileCount = Test-InstalledCuratedPayload -InstallRoot $SmokeInstallRoot -Payload $Payload
if ($PostSelfTestInstalledPayloadFileCount -ne $InstalledPayloadFileCount) {
